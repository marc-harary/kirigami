...
def main():
    ...
    learner = KirigamiModule.load_from_checkpoint(args.checkpoint)
    ...
    train_dataset = torch.load("TR0-all.pt")
    val_dataset = torch.load("VL0-all.pt")
    test_dataset = torch.load("TS0-all.pt")
